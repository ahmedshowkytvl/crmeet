...
# -*- coding: utf-8 -*-
"""
Quick ticket info viewer - Simple version
"""
...
def get_ticket_info_simple(ticket_id):
    """Get ticket information in simple format"""
    zoho = ZohoAPI()
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python quick_ticket_info.py <ticket_id>")
        print("Example: python quick_ticket_info.py 766285000467334620")
        sys.exit(1)
    
    get_ticket_info_simple(sys.argv[1])
