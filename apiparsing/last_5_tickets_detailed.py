...
# -*- coding: utf-8 -*-
"""
Display last 5 tickets with detailed information (for testing)
"""
...
def display_ticket_detailed(ticket, index):
    ...
    print(f"\n{'='*80}")
    print(f"🎫 TICKET #{ticket.get('ticketNumber', 'N/A')} INFORMATION ({index}/5)")
    print(f"{'='*80}")
...
def get_last_5_tickets_detailed():
    """Get and display last 5 tickets with detailed information"""
    zoho = ZohoAPI()
    
    print("🔍 Getting last 5 tickets with detailed information...")
