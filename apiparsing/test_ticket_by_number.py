...
# -*- coding: utf-8 -*-
"""
Test processing time calculation on ticket by number
"""
...
def test_ticket_by_number():
    """Test processing time on ticket by number"""
    zoho = ZohoAPI()
    ...
    for ticket in tickets:
        if ticket.get('ticketNumber') == '2818683':
            target_ticket = ticket
            break
    
    if not target_ticket:
        print("❌ Ticket #2818683 not found in recent tickets")
        return
