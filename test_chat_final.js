// اختبار Playwright MCP النهائي لإرسال رسالة في الدردشة
import { chromium } from 'playwright';

async function testChatFinal() {
    console.log('🚀 بدء الاختبار النهائي لإرسال رسالة في الدردشة...\n');
    ...
    try {
        ...
        // 5. إرسال رسالة باستخدام الواجهة
        console.log('\n📤 الخطوة 5: إرسال رسالة باستخدام الواجهة...');
        
        const messageInput = await page.locator('#messageInput').first();
        const sendButton = await page.locator('#sendMessageBtn').first();
        
        const testMessage = `رسالة اختبار نهائية - ${new Date().toLocaleTimeString()}`;
        ...
        // 7. إرسال رسالة باستخدام JavaScript مباشرة
        console.log('\n📤 الخطوة 7: إرسال رسالة باستخدام JavaScript مباشرة...');
        ...
        try {
            ...
            }, `رسالة JavaScript مباشرة - ${new Date().toLocaleTimeString()}`);
            
            console.log(`✅ نتيجة الإرسال المباشر: ${result}`);
            ...
            console.log(`❌ خطأ في الإرسال المباشر: ${error.message}`);
        }
        ...
        // 9. فحص الرسائل في قاعدة البيانات
        console.log('\n🗄️ الخطوة 9: فحص الرسائل في قاعدة البيانات...');
