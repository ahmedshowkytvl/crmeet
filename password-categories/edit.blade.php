...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('password-categories.update', $passwordCategory) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name', $passwordCategory->name) }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                   id="name_ar" name="name_ar" value="{{ old('name_ar', $passwordCategory->name_ar) }}">
                            @error('name_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="url" class="form-control @error('icon') is-invalid @enderror" 
                                   id="icon" name="icon" value="{{ old('icon', $passwordCategory->icon) }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                                       id="color" name="color" value="{{ old('color', $passwordCategory->color) }}">
                                <input type="text" class="form-control @error('color') is-invalid @enderror" 
                                       id="color_text" value="{{ old('color', $passwordCategory->color) }}" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $passwordCategory->sort_order) }}" 
                                   min="0" step="1">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" 
                                       name="is_active" value="1" {{ old('is_active', $passwordCategory->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="3">{{ old('description', $passwordCategory->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" rows="3">{{ old('description_ar', $passwordCategory->description_ar) }}</textarea>
    ...
    <div class="col-lg-4">
                ...
                <div class="d-flex align-items-start mb-3">
                    <div id="preview-icon" class="me-3 d-flex align-items-center justify-content-center" 
                        ...
                        @if($passwordCategory->icon)
                            <img src="{{ $passwordCategory->icon }}" alt="{{ $passwordCategory->display_name }}" style="width: 24px; height: 24px;">
                        @else
                            <i class="fas fa-tag text-white"></i>
                        @endif
                    </div>
                    <div class="flex-grow-1">
                        <h6 id="preview-name" class="mb-1">{{ $passwordCategory->display_name }}</h6>
                        <span id="preview-badge" class="badge" style="background-color: {{ $passwordCategory->color }};">
                            {{ $passwordCategory->passwordAccounts->count() }} {{ __('Accounts') }}
                        </span>
                    </div>
                </div>
                <p id="preview-description" class="text-muted small mb-0">
                    {{ $passwordCategory->display_description ?: __('Category description will appear here...') }}
                </p>
            </div>
        </div>
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h5 class="mb-0">{{ __('Category Statistics') }}</h5>
            </div>
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-6">
                        <h4 class="text-primary">{{ $passwordCategory->passwordAccounts->count() }}</h4>
                        <small class="text-muted">{{ __('Total Accounts') }}</small>
                    </div>
                    <div class="col-6">
                        <h4 class="text-success">{{ $passwordCategory->passwordAccounts->where('is_active', true)->count() }}</h4>
